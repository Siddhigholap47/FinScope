...
const rotatingTexts = ['Plan. Save. Celebrate.', 'Your Money, Your Goals.', 'Make Finance Fun.'];
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-700 text-center mb-6">Login to continue your financial journey</p>
