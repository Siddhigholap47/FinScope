...
import { User, Users, Receipt, Settings as SettingsIcon, Bell, Lock, Globe, IndianRupee, Camera, Mail, Phone } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-gray-600 mt-1">Manage your account, preferences, and shared budgets</p>
      </motion.div>
        ...
        <Tabs defaultValue="profile" className="w-full">
          ...
          <TabsContent value="profile" className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleSaveProfile} className="bg-[#4E61D3] rounded-xl">
                  Save Changes
                </Button>
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          with {partner.name} • {partner.yourContribution}%-{partner.theirContribution}% split
                        </p>
                      </div>
                    </div>
                    <Button
          ...
          <TabsContent value="receipts" className="space-y-4">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500">Upload receipts when adding expenses to track them better</p>
            </div>
          </TabsContent>
                ...
                <div className="flex items-center justify-between p-4 bg-white/60 rounded-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Choose display language</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white/60 rounded-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get notified about expenses and goals</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white/60 rounded-2xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Receive budget summaries via email</p>
                    </div>
                  </div>
                  <Switch checked={emailAlerts} onCheckedChange={setEmailAlerts} />
                </div>

                <Button onClick={handleSavePreferences} className="bg-[#4E61D3] rounded-xl">
                  Save Preferences
                </Button>
              </div>
            </div>
